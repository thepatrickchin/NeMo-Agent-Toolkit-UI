...
IMAGE_NAME="talk-to-data-agent-ui-stage"
AWS_REGION="us-east-1"
VERSION="latest"
AWS_ACCOUNT_ID="166838993696"
ECR_REPOSITORY="talk-to-data-agent-ui-stage"
IMAGE_TAG="latest"
...
if [ -f ".env-stg-overlay" ]; then
    cp .env-stg-overlay .env
    echo "✅ Copied .env-stg-overlay to .env for build context"
else
    echo "❌ .env-stg-overlay file not found!"
    exit 1
fi
